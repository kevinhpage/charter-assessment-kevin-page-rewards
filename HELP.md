...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/3.1.0-M2/reference/htmlsingle/#appendix.configuration-metadata.annotation-processor)
* [JDBC API](https://docs.spring.io/spring-boot/docs/3.1.0-M2/reference/htmlsingle/#data.sql)
